...
## Current Mapping Rules for type: curve

```
(no rules yet — this is the first session for type 'curve')
```
...
Write your spec to:
  `/home/pete/Source/ethos/migrator/browser/tests/primitives/curve-0-session-1.spec.ts`

Run it with:
```bash
cd /home/pete/Source/ethos/migrator/browser
npx playwright test tests/primitives/curve-0-session-1.spec.ts --reporter=list --project=chromium
```
...
2. **Write** the Playwright spec at `/home/pete/Source/ethos/migrator/browser/tests/primitives/curve-0-session-1.spec.ts`
...
5. **Update** `/home/pete/Source/ethos/migrator/skills/primitives/curve.md` with confirmed steps or failure notes
6. **Write** `/home/pete/Source/ethos/migrator/primitive-migration/sessions/BAMF2_Std/curve-0/session-1/result.txt`:
...
| File | Content |
|------|---------|
| `/home/pete/Source/ethos/migrator/primitive-migration/sessions/BAMF2_Std/curve-0/session-1/result.txt` | SUCCESS or LEARN: notes |
| `/home/pete/Source/ethos/migrator/skills/primitives/curve.md` | Updated mapping rules for type 'curve' |
