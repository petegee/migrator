...
Write your spec to:
  `/home/pete/Source/ethos/migrator/browser/tests/primitives/mix-1-session-3.spec.ts`

Run it with:
```bash
cd /home/pete/Source/ethos/migrator/browser
npx playwright test tests/primitives/mix-1-session-3.spec.ts --reporter=list --project=chromium
```
...
2. **Write** the Playwright spec at `/home/pete/Source/ethos/migrator/browser/tests/primitives/mix-1-session-3.spec.ts`
...
6. **Write** `/home/pete/Source/ethos/migrator/primitive-migration/sessions/BAMF2_Std/mix-1/session-3/result.txt`:
...
| File | Content |
|------|---------|
| `/home/pete/Source/ethos/migrator/primitive-migration/sessions/BAMF2_Std/mix-1/session-3/result.txt` | SUCCESS or LEARN: notes |
