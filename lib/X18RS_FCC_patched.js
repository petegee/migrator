...
function findWasmBinary() {
  return locateFile('X18RS_FCC.wasm');
}
...
// Begin JS library code
  ...
  writeStat(buf, stat) {
        ...
        HEAP64[(((buf)+(24))>>3)] = BigInt(stat.size || 0);
        HEAP32[(((buf)+(32))>>2)] = 4096;
        HEAP32[(((buf)+(36))>>2)] = stat.blocks;
        var atime = stat.atime.getTime();
        var mtime = stat.mtime.getTime();
        var ctime = stat.ctime.getTime();
        HEAP64[(((buf)+(40))>>3)] = BigInt(Math.floor((atime||0) / 1000));
        HEAPU32[(((buf)+(48))>>2)] = (atime % 1000) * 1000 * 1000;
        HEAP64[(((buf)+(56))>>3)] = BigInt(Math.floor((mtime||0) / 1000));
        HEAPU32[(((buf)+(64))>>2)] = (mtime % 1000) * 1000 * 1000;
        HEAP64[(((buf)+(72))>>3)] = BigInt(Math.floor((ctime||0) / 1000));
        HEAPU32[(((buf)+(80))>>2)] = (ctime % 1000) * 1000 * 1000;
        HEAP64[(((buf)+(88))>>3)] = BigInt(stat.ino || 0);
        return 0;
      },
  writeStatFs(buf, stats) {
        HEAPU32[(((buf)+(4))>>2)] = stats.bsize;
        HEAPU32[(((buf)+(60))>>2)] = stats.bsize;
        HEAP64[(((buf)+(8))>>3)] = BigInt(stats.blocks || 0);
        HEAP64[(((buf)+(16))>>3)] = BigInt(stats.bfree || 0);
        HEAP64[(((buf)+(24))>>3)] = BigInt(stats.bavail || 0);
        HEAP64[(((buf)+(32))>>3)] = BigInt(stats.files || 0);
        HEAP64[(((buf)+(40))>>3)] = BigInt(stats.ffree || 0);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(9, 0, 1, dirfd, path, mode);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(12, 0, 1, olddirfd, oldpath, newdirfd, newpath);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(13, 0, 1, path);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(16, 0, 1, dirfd, path, times, flags);
  ...
  try {
      ...
      HEAP64[((newOffset)>>3)] = BigInt(stream.position || 0);
...
var ASM_CONSTS = {
  9373392: () => { FS.syncfs(false, function (err) { ccall('onSyncFsDone', 'void', [], []); if (err) { console.error("Sync to IndexedDB failed:", err) } else if (Module.syncToLocal) { Module.syncToLocal() } }) },  
 9373587: ($0) => { Module.setSwitchesConfig && Module.setSwitchesConfig($0) },  
 9373648: ($0, $1) => { Module.setSwitchesPosition && Module.setSwitchesPosition($0, $1) },  
 9373717: ($0, $1) => { Module.setFunctionSwitchesState && Module.setFunctionSwitchesState($0, $1) },  
 9373796: ($0, $1) => { Module.setTrimsValue && Module.setTrimsValue($0, $1) },  
 9373853: ($0, $1) => { Module.audioPushBuffer && Module.audioPushBuffer($0, $1) },  
 9373914: ($0, $1, $2) => { Module.updateCanvas && Module.updateCanvas($0, $1, $2) }
};
...
var _setFunctionSwitchPressed = Module['_setFunctionSwitchPressed'] = makeInvalidEarlyAccess('_setFunctionSwitchPressed');
var _onSyncFsDone = Module['_onSyncFsDone'] = makeInvalidEarlyAccess('_onSyncFsDone');
var _onMouseDown = Module['_onMouseDown'] = makeInvalidEarlyAccess('_onMouseDown');
var _onMouseUp = Module['_onMouseUp'] = makeInvalidEarlyAccess('_onMouseUp');
var _onMouseMove = Module['_onMouseMove'] = makeInvalidEarlyAccess('_onMouseMove');
var _onMouseLongPress = Module['_onMouseLongPress'] = makeInvalidEarlyAccess('_onMouseLongPress');
var _onMouseWheel = Module['_onMouseWheel'] = makeInvalidEarlyAccess('_onMouseWheel');
var _setSwitchPosition = Module['_setSwitchPosition'] = makeInvalidEarlyAccess('_setSwitchPosition');
var _setAnalogPosition = Module['_setAnalogPosition'] = makeInvalidEarlyAccess('_setAnalogPosition');
var _setTrimPressed = Module['_setTrimPressed'] = makeInvalidEarlyAccess('_setTrimPressed');
var _onKeyEvent = Module['_onKeyEvent'] = makeInvalidEarlyAccess('_onKeyEvent');
var _main = Module['_main'] = makeInvalidEarlyAccess('_main');
var _start = Module['_start'] = makeInvalidEarlyAccess('_start');
var _stop = Module['_stop'] = makeInvalidEarlyAccess('_stop');
var _getCurrentModel = Module['_getCurrentModel'] = makeInvalidEarlyAccess('_getCurrentModel');
var _writeDefaultSettingsAndModel = Module['_writeDefaultSettingsAndModel'] = makeInvalidEarlyAccess('_writeDefaultSettingsAndModel');
var _setLanguage = Module['_setLanguage'] = makeInvalidEarlyAccess('_setLanguage');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['setFunctionSwitchPressed'] != 'undefined', 'missing Wasm export: setFunctionSwitchPressed');
  assert(typeof wasmExports['onSyncFsDone'] != 'undefined', 'missing Wasm export: onSyncFsDone');
  assert(typeof wasmExports['onMouseDown'] != 'undefined', 'missing Wasm export: onMouseDown');
  assert(typeof wasmExports['onMouseUp'] != 'undefined', 'missing Wasm export: onMouseUp');
  assert(typeof wasmExports['onMouseMove'] != 'undefined', 'missing Wasm export: onMouseMove');
  assert(typeof wasmExports['onMouseLongPress'] != 'undefined', 'missing Wasm export: onMouseLongPress');
  assert(typeof wasmExports['onMouseWheel'] != 'undefined', 'missing Wasm export: onMouseWheel');
  assert(typeof wasmExports['setSwitchPosition'] != 'undefined', 'missing Wasm export: setSwitchPosition');
  assert(typeof wasmExports['setAnalogPosition'] != 'undefined', 'missing Wasm export: setAnalogPosition');
  assert(typeof wasmExports['setTrimPressed'] != 'undefined', 'missing Wasm export: setTrimPressed');
  assert(typeof wasmExports['onKeyEvent'] != 'undefined', 'missing Wasm export: onKeyEvent');
  assert(typeof wasmExports['__main_argc_argv'] != 'undefined', 'missing Wasm export: __main_argc_argv');
  assert(typeof wasmExports['start'] != 'undefined', 'missing Wasm export: start');
  assert(typeof wasmExports['stop'] != 'undefined', 'missing Wasm export: stop');
  assert(typeof wasmExports['getCurrentModel'] != 'undefined', 'missing Wasm export: getCurrentModel');
  assert(typeof wasmExports['writeDefaultSettingsAndModel'] != 'undefined', 'missing Wasm export: writeDefaultSettingsAndModel');
  assert(typeof wasmExports['setLanguage'] != 'undefined', 'missing Wasm export: setLanguage');
  ...
  _setFunctionSwitchPressed = Module['_setFunctionSwitchPressed'] = createExportWrapper('setFunctionSwitchPressed', 2);
  _onSyncFsDone = Module['_onSyncFsDone'] = createExportWrapper('onSyncFsDone', 0);
  _onMouseDown = Module['_onMouseDown'] = createExportWrapper('onMouseDown', 2);
  _onMouseUp = Module['_onMouseUp'] = createExportWrapper('onMouseUp', 2);
  _onMouseMove = Module['_onMouseMove'] = createExportWrapper('onMouseMove', 2);
  _onMouseLongPress = Module['_onMouseLongPress'] = createExportWrapper('onMouseLongPress', 0);
  _onMouseWheel = Module['_onMouseWheel'] = createExportWrapper('onMouseWheel', 1);
  _setSwitchPosition = Module['_setSwitchPosition'] = createExportWrapper('setSwitchPosition', 2);
  _setAnalogPosition = Module['_setAnalogPosition'] = createExportWrapper('setAnalogPosition', 2);
  _setTrimPressed = Module['_setTrimPressed'] = createExportWrapper('setTrimPressed', 2);
  _onKeyEvent = Module['_onKeyEvent'] = createExportWrapper('onKeyEvent', 4);
  _main = Module['_main'] = createExportWrapper('__main_argc_argv', 2);
  _start = Module['_start'] = createExportWrapper('start', 0);
  _stop = Module['_stop'] = createExportWrapper('stop', 0);
  _getCurrentModel = Module['_getCurrentModel'] = createExportWrapper('getCurrentModel', 0);
  _writeDefaultSettingsAndModel = Module['_writeDefaultSettingsAndModel'] = createExportWrapper('writeDefaultSettingsAndModel', 0);
  _setLanguage = Module['_setLanguage'] = createExportWrapper('setLanguage', 1);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = X18RS_FCC;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = X18RS_FCC;
